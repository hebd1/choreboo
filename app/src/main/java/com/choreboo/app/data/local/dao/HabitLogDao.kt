...
interface HabitLogDao {
    ...
    @Query("SELECT DISTINCT date FROM habit_logs WHERE habitId = :habitId AND date >= :since ORDER BY date DESC")
    suspend fun getCompletionDatesForHabit(habitId: Long, since: String): List<String>
