...
import com.choreboo.app.domain.model.PurchasedBackground
...
class BackgroundRepository @Inject constructor(
     ...
     */
    fun getPurchasedBackgrounds(uid: String): Flow<List<PurchasedBackground>> {
...
private fun PurchasedBackgroundEntity.toDomain() = PurchasedBackground(
    ownerUid = ownerUid,
    backgroundId = backgroundId,
