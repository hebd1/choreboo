package com.example.weeboo_habittrackerfriend.data.datastore
...
val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "weeboo_preferences")
